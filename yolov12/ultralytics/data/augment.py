...
from yolov12.ultralytics.data.utils import polygons2masks, polygons2masks_overlap
from yolov12.ultralytics.utils import LOGGER, colorstr
from yolov12.ultralytics.utils.checks import check_version
from yolov12.ultralytics.utils.instance import Instances
from yolov12.ultralytics.utils.metrics import bbox_ioa
from yolov12.ultralytics.utils.ops import segment2box, xyxyxyxy2xywhr
from yolov12.ultralytics.utils.torch_utils import TORCHVISION_0_10, TORCHVISION_0_11, TORCHVISION_0_13
...
class Compose:
    ...
    def __init__(self, transforms):
        ...
        Examples:
            >>> from yolov12.ultralytics.data.augment import Compose, RandomHSV, RandomFlip
...
class Mosaic(BaseMixTransform):
    ...
    Examples:
        >>> from yolov12.ultralytics.data.augment import Mosaic
...
class MixUp(BaseMixTransform):
    ...
    Examples:
        >>> from yolov12.ultralytics.data.augment import MixUp
        >>> dataset = YourDataset(...)  # Your image dataset
...
class RandomHSV:
    ...
    Examples:
        >>> import numpy as np
        >>> from yolov12.ultralytics.data.augment import RandomHSV
...
class CopyPaste(BaseMixTransform):
    ...
    Examples:
        >>> from yolov12.ultralytics.data.augment import CopyPaste
        >>> dataset = YourDataset(...)  # Your image dataset
